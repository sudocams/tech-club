...
external database server.
    ...
    DemoteMain.method_config = lambda: base_api.ApiMethodInfo(
        http_method=u'POST',
        method_id=u'sql.instances.demoteMain',
        ordered_params=[u'project', u'instance'],
        path_params=[u'instance', u'project'],
        query_params=[],
        relative_path=u'sql/v1beta4/projects/{project}/instances/{instance}/demoteMain',
        request_field=u'instancesDemoteMainRequest',
        request_type_name=u'SqlInstancesDemoteMainRequest',
        response_type_name=u'Operation',
        supports_download=False,
    )
